...
# Set your API key
genai.configure(api_key="AIzaSyDMSIXhJJXpPCyDWgWtciAl-CSUNkCIqsg")

# Define the desired accessibility type
# Options: "wheelchair", "visual", "auditory", "cognitive", or "all"
accessibility_type = "visual"  # This can be dynamically set from the UI

original_image_path = "stairs.jpeg"
depth_map_path = "stairs_depth.png"
annotated_image_path = "stairs_annotated.png"
